...
public class getterBL {
	...
	/**
	 * @param szUserName
	 *            - the user-name that the user send
	 * @param szPassword
	 *            - the password that the user send
	...
	/**
	 * @param szUserName
	 *            - the user-name that will found for hem the id
	 ...
	 * 
	 * @param nUserId
	 *            - the user-id that will found for hem the user-name
	...
	/**
	 * @param szUserName
	 *            - the userName that we want to check if still exist
	...
	/**
	 * @param szEmail
	 *            - the email that we want to check if still exist
	 ...
	 * 
	 * @param szUserName
	 *            - the user that suppose to be the debter
